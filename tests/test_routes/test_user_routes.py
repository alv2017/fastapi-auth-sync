...
class TestUsersRegistrationEndpoint:
    ...
    async def test_register_user_success(self, async_test_client_with_db_access, user_data):
    ...
    async def test_register_user_conflict(self, async_test_client_with_db_access, user_data):
        ac = async_test_client_with_db_access
    ...
    async def test_register_with_invalid_data_missing_username(self, async_test_client_with_db_access):
        ac = async_test_client_with_db_access
        invalid_user_data = {
    ...
    async def test_register_with_invalid_data_missing_email(self, async_test_client_with_db_access):
        ac = async_test_client_with_db_access
        invalid_user_data = {
            "username": "test-user",
            "password": "Strong-Unbreakable-Password-07"
    ...
    async def test_register_with_invalid_data_missing_password(self, async_test_client_with_db_access):
        ac = async_test_client_with_db_access
        invalid_user_data = {
            "username": "test-user",
            "email": "test-user@example.com"
    ...
    async def test_register_with_invalid_data_username_too_short(self, async_test_client_with_db_access):
        ac = async_test_client_with_db_access
        invalid_user_data = {
            "username": "tu",
            "email": "test-user@example.com",
...
class TestGetUserMeEndpoint:
    ...
    async def test_get_user_me_expired_token(self, async_test_client_with_expired_token):
    ...
    async def test_get_user_me_invalid_token(self, async_test_client_with_invalid_token):
